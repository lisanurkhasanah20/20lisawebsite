...
$query = "SELECT * FROM furniture WHERE id_barang='" . $_GET['id_barang'] . "'";
            ...
            <div class="col-md-12"> 
                <form action="edit_process.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail">Id_barang</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="namabarang" class="form-control" value="<?php echo $customer["nama_barang"] ?>" required> 
                    </div> 
                    <div class="form-group">
                        <label for="exampleInputEmail">Jumlah Barang</label>
                        <input type="text" name="jumlahbarang" class="form-control" value="<?php echo $customer["jumlah_barang"] ?>" required> 
                    </div>
                    <div class="form-group">
